...
\todo{SRC division problem?} in which a number cannot be equally divided. In
\autoref{cpt:properties}, we defined that the precision in this case should be
of X \todo{Define X} decimals. However, the test framework does not specifically
...
\todo{Define X}. However, as we have seen in this experiment, the generated
...
\todo{Define x}. However, the test framework does not yet take this rule into
