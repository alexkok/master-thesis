...
definition for using division with the \textit{Monye} type wasn't clear enough
...
The additional properties that are being added also use implication in their definitions. In the second experiment (\autoref{cpt:experiment2}), the value generator was not dynamic enough in that it requires modifications for each implicative property that is being added. In this experiment we aim to improve this, by using the defined preconditions to determine the input values.\\
\\
