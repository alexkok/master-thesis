...
In the following sections we motivate the properties that we use throughout this
thesis.
% % % % % % % % % % % % %
...
operations with certain types. These properties can be used to test the
