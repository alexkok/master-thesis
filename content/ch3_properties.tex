...
and division (defined as \code{$x \cdot (1 / x) \equiv 0$}), it is not possible to use this
...
The properties in this category are mainly using the equality ($\equiv$, $\neq$) and
...
exactly one of the relations \textit{$<$}, \textit{$\equiv$}, \textit{$>$} holds. We
...
\rowcolor[HTML]{EFEFEF}                                                         &                        & $z$ : Money              \\
                        round($x$) $\equiv$ round($z \cdot y$) $\implies$
												               round($x / y$) $\equiv$ round($z$)       & divisionEquality2      & $x$ : Money              \\
                                                                                &                        & $y$ : Integer            \\
                                                                                &                        & $z$ : Money              \\
