...
thesis, with a motivation why these properties are expected to hold. Next, we
will provide a discussion about the properties that we defined.
...
\section{Determining the properites}
...
in~\cite{goldberg1991every}. Which can have a huge impact on the system and the
bank. The precision errors for instance, should be avoided when using the
