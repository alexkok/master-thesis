...
\todo{Put the right properties into the right category. And fix references among them}
...
than zero. \todo{Incorporate (define X)}
...
categories: ``\nameref{ssct:properties_definitions_fieldproperties}'' and
``\nameref{ssct:properties_definitions_equalityproperties}''. An overview of the
defined properties is shown in ...\todo{Add table}, the ellipsis is used to
